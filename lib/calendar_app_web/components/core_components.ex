defmodule CalendarAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CalendarAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CalendarAppWeb.Gettext, "errors", msg, opts)
    end
  end
